    ...
    public class BeanCounterSpawner : MonoBehaviour
    {
        ...
        public void SpawnBeanCounter(Vector2Int coord, int ownerId = 0)
        {
            ...
            var visual = CreatureNetView.HostActive
                ? CreatureNetView.CreateHostBody(EditorCreatureKind.BeanCounter, worldPos)
                : CreatureFactory.CreateOfflineBody(EditorCreatureKind.BeanCounter, worldPos);
            ...
            CreatureNetView.HostFinalize(visual, EditorCreatureKind.BeanCounter, agent.Creature);
