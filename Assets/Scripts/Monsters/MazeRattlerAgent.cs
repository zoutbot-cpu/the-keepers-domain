...
namespace KeepersDomain.Monsters
{
    ...
    public class MazeRattlerAgent : MonoBehaviour
    {
        ...
        public void Initialize(DungeonGrid grid, LairManager lairManager, BaconBeaconManager baconBeaconManager, TrainingRoomManager trainingRoomManager, JailManager jailManager, TreasuryManager treasuryManager, Portal portal)
        {
            _grid = grid;
        ...
        private void Update()
        {
            ...
            _happiness.Tick(Time.deltaTime, _hunger.IsHungry, _task == MazeRattlerTask.Training);
